...
import Header from '@/components/Header'; // Garante que o seu cabeçalho oficial apareça
            ...
            {[
              ...
              return (
                <button
                  ...
                  className={`px-5 py-3 rounded-t-xl text-xs font-black uppercase tracking-wider whitespace-nowrap transition-all border-b-2 ${
                    ativa 
